...
public class NoWallsScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout noWallsScoreLayout = (RelativeLayout) findViewById(R.id.nowalls_score_layout);
        ...
        noWallsScoreLayout.addView(adView, adViewParams);
    ...
    private void initScore() {
        ...
        animation = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.anim_for_classic_button);
    ...
    private void setHighScore() {
        ...
        int highScore = preferences.getInt(GameSettings.SHAREDPREFS_HIGHSCORE_NOWALLS, 0);
        int lastScore = preferences.getInt(GameSettings.SHAREDPREFS_LASTSCORE, 0);

        if (lastScore > highScore) {
            highScore = lastScore;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(GameSettings.SHAREDPREFS_HIGHSCORE_NOWALLS, lastScore);
            editor.apply();
        }
            ...
            public void onAnimationEnd(final Animation animation) {
                ...
                mainMenuImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Animation animationTopLeft = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.reverse_for_classic_button);
                        animationTopLeft.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationTopRight = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.reverse_for_no_button);
                        animationTopRight.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationBottomLeft = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.reverse_for_settings_button);
                        animationBottomLeft.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationBottomRight = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.reverse_for_bomb_button );
                        animationBottomRight.setDuration(GameSettings.ANIMATION_CLOSE_BUTTON_DURATION);

                        Animation animationLeft = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.anim_for_title_left);
                        animationLeft.setDuration(GameSettings.ANIMATION_HIDE_TITLE_DURATION);

                        Animation animationMiddle = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.anim_for_title_middle);
                        animationMiddle.setDuration(GameSettings.ANIMATION_HIDE_TITLE_DURATION);

                        Animation animationRight = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.anim_for_title_right);
                        ...
                        myHandler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intentMainMenu = new Intent(NoWallsScore.this, MainMenu.class);
    ...
    private void initTitle() {
        ...
        Animation animationLeft = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.back_anim_for_title_left);
        animationLeft.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);
        gameOverTitleLeft.startAnimation(animationLeft);

        Animation animationMiddle = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.back_anim_for_title_middle);
        animationMiddle.setDuration(GameSettings.ANIMATION_SHOW_TITLE_DURATION);
        gameOverTitleMiddle.startAnimation(animationMiddle);

        Animation animationRight = AnimationUtils.loadAnimation(NoWallsScore.this, R.anim.back_anim_for_title_right);
